...
const sections = [
  ...
  },
  {
    ...
    content:
      "Your data is encrypted in transit and at rest. We use industry-standard security practices including HTTPS, encrypted databases, and access controls. Our infrastructure is hosted on GDPR-compliant servers. Access to user data is restricted to essential team members only.",
  },
  {
    title: "7. Your Rights (GDPR and Beyond)",
    content:
  ...
  },
  {
    ...
    content:
      "FocusBox is designed for use by parents and guardians. Children interact only with the physical device — they do not create accounts, provide personal information, or use the mobile app. Our system is architected to comply with the principles of COPPA and GDPR provisions for minors by simply not collecting child personal data in the first place.",
  },
  {
    title: "9. Changes to This Policy",
    content:
      "We may update this policy as our product evolves. If we make material changes, we will notify you via email and update the date at the top of this page. Continued use of FocusBox after changes constitutes acceptance of the updated policy.",
  },
  {
    title: "10. Contact Us",
    content:
      "For any privacy questions, data requests, or concerns: privacy@focusbox.io. We aim to respond within 48 hours.",
  },
];
        ...
        <div className="max-w-[800px] mx-auto px-6 py-20">
          {sections.map((section, i) => (
            <Reveal key={section.title} delay={i === 0 ? 0 : 50}>
              ...
              >
                <h2
                  className="font-body text-[20px] font-bold mb-4"
                  style={{ color: "#1B2A4A" }}
                >
                  {section.title}
                </h2>
          ...
          <Reveal delay={100}>
            ...
            >
              ...
              <a
                href="mailto:privacy@focusbox.io"
