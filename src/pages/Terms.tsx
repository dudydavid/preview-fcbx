    ...
    <>
      ...
      <section style={{ background: "#F8FAFC" }}>
        <div className="max-w-[800px] mx-auto px-6 max-[767px]:px-5 pt-[140px] pb-[60px] text-center">
          ...
          <Reveal delay={100}>
            <h1 className="font-display mt-4 mb-4" style={{ fontSize: "clamp(32px, 4vw, 48px)", color: "#0F172A" }}>Terms of Service</h1>
          </Reveal>
          <Reveal delay={200}>
        ...
        <div className="max-w-[800px] mx-auto px-6 max-[767px]:px-5 py-20 max-[767px]:py-14">
          ...
          <Reveal delay={100}>
            <div className="mt-16 rounded-[16px] p-6 text-center" style={{ background: "#F8FAFC", border: "1px solid #E2E8F0" }}>
              <p className="font-body text-[18px] font-bold mb-1" style={{ color: "#0F172A" }}>Have questions about our terms?</p>
              <p className="font-body text-[15px] mb-3" style={{ color: "#475569" }}>We believe in clarity. Ask us anything.</p>
              <Link to="/contact" className="font-body text-[15px] font-semibold inline-flex items-center gap-1" style={{ color: "#2563EB" }}>Contact Us →</Link>
            </div>
          </Reveal>
        </div>
      </section>
