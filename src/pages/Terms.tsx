...
const sections = [
  ...
  { title: "5. Purchase, Pricing, and Payment", content: "FocusBox is not currently for sale. No product has shipped and no pricing has been set. Should FocusBox become available in the future, applicable prices, subscription terms, and payment details will be displayed before any purchase and these Terms will be updated accordingly." },
